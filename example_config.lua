...
hs.hotkey.bind({"alt"}, "space", function() os.execute("~/bin/open-terminal.sh", true) end)
hs.hotkey.bind({"alt"}, "n", function() os.execute("~/bin/open-finder.sh", true) end)
hs.hotkey.bind({"alt"}, "c", function() os.execute("~/bin/open-browser.sh", true) end)
hs.hotkey.bind({"alt"}, "z", function() os.execute("~/bin/bitbar-plugins/chunkwm_bar.60e0s.py rename", true) end)
hs.hotkey.bind({"alt"}, "g", function() os.execute("~/bin/open-gvim.sh", true) end)
